...
- [x] [CORS 해결하기](https://velog.io/@takeknowledge/로컬에서-CORS-policy-관련-에러가-발생하는-이유-3gk4gyhreu) 
- [ ] randomNumberGenerator(): computerInputNumbers 생성 함수
- [ ] play(): computerInputNumbers, userInputNumbers 비교해 string 반환 함수
- [ ] game-restart-button 버튼
